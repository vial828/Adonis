...
#if defined(_GPIO_PSE84_WLB_154_H_)
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rxd[1] = {
    {0u, 0u, NC, HSIOM_SEL_GPIO},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_txd[1] = {
    {0u, 0u, NC, HSIOM_SEL_GPIO},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_m33syscpuss_fault[2] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_m1[3] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_dout[3] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_obsrv[1] = {
    {0u, 0u, NC, HSIOM_SEL_GPIO},
};

/* Connections for: pass_ptc_pads */
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_ptc_pads[4] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[96] = {
