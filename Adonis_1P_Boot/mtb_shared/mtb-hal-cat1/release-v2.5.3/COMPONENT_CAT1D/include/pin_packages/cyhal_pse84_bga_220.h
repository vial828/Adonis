...
#ifndef _CYHAL_PSE84_BGA_220_H_
#define _CYHAL_PSE84_BGA_220_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pse84_bga_220 PSE84 BGA-220
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSE84 BGA-220 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the BGA-220 package for the PSE84 series. */
typedef enum {
...
} cyhal_gpio_pse84_bga_220_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pse84_bga_220_t cyhal_gpio_t;
