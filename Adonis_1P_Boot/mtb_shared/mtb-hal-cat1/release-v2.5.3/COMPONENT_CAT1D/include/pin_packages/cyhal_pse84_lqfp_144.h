...
#ifndef _CYHAL_PSE84_LQFP_144_H_
#define _CYHAL_PSE84_LQFP_144_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pse84_lqfp_144 PSE84 LQFP-144
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSE84 LQFP-144 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the LQFP-144 package for the PSE84 series. */
typedef enum {
...
} cyhal_gpio_pse84_lqfp_144_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pse84_lqfp_144_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_debug600_trace_data[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rxd[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_txd[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_m33syscpuss_fault[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_m1[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_dout[5];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_obsrv[5];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[10];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_output[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[97];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[93];
...
#endif /* _CYHAL_PSE84_LQFP_144_H_ */
