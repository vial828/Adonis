...
#ifndef _CYHAL_PSE84_EWLB_235_H_
#define _CYHAL_PSE84_EWLB_235_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pse84_ewlb_235 PSE84 eWLB-235
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSE84 eWLB-235 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the eWLB-235 package for the PSE84 series. */
typedef enum {
...
} cyhal_gpio_pse84_ewlb_235_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pse84_ewlb_235_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_debug600_trace_clock[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_debug600_trace_data[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_m33syscpuss_fault[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_out_10x[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_m0[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_m1[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_p0[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_p1[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dac_pads[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_dout[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_lppass_obsrv[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_ptc_pads[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pdm_pdm_clk[6];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[16];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_miso[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_mosi[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_miso[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_mosi[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_smif_spi_select2[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[140];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[140];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tdm_tdm_rx_sck[2];
...
#endif /* _CYHAL_PSE84_EWLB_235_H_ */
