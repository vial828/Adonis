...
/**
* \addtogroup group_hal_comp_ptc COMP (PTC)
* \ingroup group_hal_impl
* \{
* Implementation of the analog comparator (COMP) driver on top of the Programmable
* threshold comparator (PTC)
*
*/
...
/** Initialize the Comparator peripheral for a PTC-based comparator.
 *
...
/** Initialize the comparator peripheral for a PTC-based comparator using a configurator generated configuration struct
  *
 * @param[out] obj              Pointer to a comparator object. The caller must allocate the memory
 *                              for this object but the init function will initialize its contents.
...
/** Deinitialize the Comparator peripheral for a PTC-based comparator.
 *
 * @param[in] obj Comparator object
 */
void _cyhal_comp_ptc_free(cyhal_comp_t *obj);

/** Changes the current operating power level of the comparator for a PTC-based comparator.
 *
...
/** Reconfigure the Comparator for a PTC-based comparator.
 *
...
/** Reads the Comparator state for a PTC-based comparator.
 *
 * @param[in]  obj    Comparator object
...
/** Enable or Disable a Comparator event for a PTC-based comparator
 *
