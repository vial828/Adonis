...
/** \cond INTERNAL */
#define _CYHAL_DRIVER_AVAILABLE_COMP_LP     ((CY_IP_MXLPCOMP_INSTANCES) > 0) || ((CY_IP_MXS22LPCOMP_INSTANCES) > 0)
#define _CYHAL_DRIVER_AVAILABLE_COMP_PTC    ((CY_IP_MXS22LPPASS_PTC_INSTANCES) > 0)
...
#define _CYHAL_DRIVER_AVAILABLE_COMP_CTB_PASS   (((CY_IP_MXS40PASS_INSTANCES) > 0) && ((CY_IP_MXS40PASS_CTB_INSTANCES) > 0))
#define _CYHAL_DRIVER_AVAILABLE_COMP_CTB_LPASS  (((CY_IP_MXS22LPPASS_INSTANCES) > 0) && ((CY_IP_MXS22LPPASS_CTB_INSTANCES) > 0))
#define _CYHAL_DRIVER_AVAILABLE_COMP_CTB        (_CYHAL_DRIVER_AVAILABLE_COMP_CTB_PASS || _CYHAL_DRIVER_AVAILABLE_COMP_CTB_LPASS)

#define _CYHAL_DRIVER_AVAILABLE_PASS        ((CY_IP_MXS40PASS_INSTANCES) > 0) || ((CY_IP_MXS40EPASS_INSTANCES) > 0)
#define _CYHAL_DRIVER_AVAILABLE_LPPASS      ((CY_IP_MXS22LPPASS_INSTANCES) > 0)

#define _CYHAL_DRIVER_AVAILABLE_ADC_SAR     ((CY_IP_MXS40PASS_SAR_INSTANCES) > 0) || ((CY_IP_MXS40EPASS_ESAR_INSTANCES) > 0) || ((CY_IP_MXS22LPPASS_SAR_INSTANCES) > 0)
...
#if defined(COMPONENT_CAT1D)
#define CYHAL_DRIVER_AVAILABLE_ETHERNET     (CY_IP_MXETH_INSTANCES > 0)
#else
...
#define CYHAL_DRIVER_AVAILABLE_I3C          ((CY_IP_MXI3C_INSTANCES) > 0)
...
#define CYHAL_DRIVER_AVAILABLE_OPAMP        ((((CY_IP_MXS40PASS_INSTANCES) > 0) && ((CY_IP_MXS40PASS_CTB_INSTANCES) > 0)) || (((CY_IP_MXS22LPPASS_INSTANCES) > 0) && ((CY_IP_MXS22LPPASS_CTB_INSTANCES) > 0)))
#define CYHAL_DRIVER_AVAILABLE_DAC          ((((CY_IP_MXS40PASS_INSTANCES) > 0) && ((CY_IP_MXS40PASS_CTDAC_INSTANCES) > 0)) || (((CY_IP_MXS22LPPASS_INSTANCES) > 0) && ((CY_IP_MXS22LPPASS_DAC_INSTANCES) > 0)))
...
typedef enum
{
    ...
    CYHAL_RSC_PTC,       /*!< Programmable Threshold comparator */
