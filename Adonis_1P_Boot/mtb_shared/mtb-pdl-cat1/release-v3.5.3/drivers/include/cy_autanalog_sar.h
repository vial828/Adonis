...
*
* The diagram below shows the SAR ADC simplified internals.
*
...
*
* \image html LPPASS_ADC_general.png
*
...
*      (refer to \ref cy_en_autanalog_sar_ch_coeff_t)
*
* Also:
...
*    - INTERLEAVED - the enabled channels will be sampled, converted, and accumulated once per scan.
*      After e.g. cy_stc_autanalog_sar_seq_tab_lp_t::accCount scans, the accumulated results for each enabled channels are
*      optionally shifted (refer to e.g. cy_stc_autanalog_sar_mux_chan_t::accShift);
*
*      \note The requirements for using the interleaved averaging:
*      1. The Entry State must have the averaging enabled;
*      2. The same value for the average count must be used across all states with enabled averaging;
*      3. The AC cannot trigger the ADC with different multiple Entry States (scans);
*      4. The SAR generates a SAR_DONE status at the end of every scan
*         (unless configured for continuous operation, at which point only a SAR_EOS is generated),
*         regardless of the value of average count. If all channels in the scan are averaged, the AC can poll the
*         SAR_RESULT or any of the SAR_(FIR)_FIFO_DONE events triggers to determine when the averaged results are available.
*         If only a subset of channels are averaged in a scan, it is up to the AC to count the number of scans to determine
*         when the averaged results are available.
*
...
*
* \note The configuration must be done only under the AC in High Speed mode,
...
typedef enum
{
    CY_AUTANALOG_SAR_PIN_MUX_COREIO0     =  0UL, /**< The CTBL0 GPIO pin 1 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO1     =  1UL, /**< The CTBL0 GPIO pin 4 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO2     =  2UL, /**< The CTBL0 GPIO pin 6 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO3     =  3UL, /**< The CTBL0 GPIO pin 7 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO4     =  4UL, /**< The CTBL1 GPIO pin 1 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO5     =  5UL, /**< The CTBL1 GPIO pin 4 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO6     =  6UL, /**< The CTBL1 GPIO pin 6 */
    CY_AUTANALOG_SAR_PIN_MUX_COREIO7     =  7UL, /**< The CTBL1 GPIO pin 7 */
    CY_AUTANALOG_SAR_PIN_MUX_CTBL0_OA0   =  8UL, /**< The CTBL0 OpAmp0 output */
    CY_AUTANALOG_SAR_PIN_MUX_CTBL0_OA1   =  9UL, /**< The CTBL0 OpAmp1 output */
    CY_AUTANALOG_SAR_PIN_MUX_CTBL1_OA0   = 10UL, /**< The CTBL1 OpAmp0 output */
    CY_AUTANALOG_SAR_PIN_MUX_CTBL1_OA1   = 11UL, /**< The CTBL1 OpAmp1 output */
    CY_AUTANALOG_SAR_PIN_MUX_VREF0       = 12UL, /**< The DAC0 output  */
    CY_AUTANALOG_SAR_PIN_MUX_VREF1       = 13UL, /**< The DAC1 output  */
    ...
    CY_AUTANALOG_SAR_PIN_MUX_VSSA_KELVIN = 25UL, /**< The ADC ground */
...
typedef enum
{
    ...
    CY_AUTANALOG_SAR_VREF_PRB_VREF0 = 4UL, /**< The ADC reference is Vref0 from the PRB */
    CY_AUTANALOG_SAR_VREF_PRB_VREF1 = 5UL, /**< The ADC reference is Vref1 from the PRB */
...
/** The FIFO selection for FIR filter results,
 * for more details, refer to the device Architecture Technical Reference Manual.
 */
typedef enum
{
    CY_AUTANALOG_SAR_FIR_FIFO_DISABLED = 0UL, /**< The FIFO is not used */
    CY_AUTANALOG_SAR_FIR_FIFO0         = 1UL, /**< The FIFO 0 */
    CY_AUTANALOG_SAR_FIR_FIFO1         = 2UL, /**< The FIFO 1 */
    CY_AUTANALOG_SAR_FIR_FIFO2         = 3UL, /**< The FIFO 2 */
    CY_AUTANALOG_SAR_FIR_FIFO3         = 4UL, /**< The FIFO 3 */
    CY_AUTANALOG_SAR_FIR_FIFO4         = 5UL, /**< The FIFO 4 */
    CY_AUTANALOG_SAR_FIR_FIFO5         = 6UL, /**< The FIFO 5 */
    CY_AUTANALOG_SAR_FIR_FIFO6         = 7UL, /**< The FIFO 6 */
    CY_AUTANALOG_SAR_FIR_FIFO7         = 8UL, /**< The FIFO 7 */

} cy_en_autanalog_sar_fir_fifo_t;
...
typedef struct
{
    ...
    cy_en_autanalog_sar_pin_hs_t   negPin;     /**< The negative pin assignment for Pseudo differential mode */
...
typedef struct
{
    uint8_t                           chanEn;       /**< Enable the GPIO channels, valid range 0...7,
...
*
* \param sarStaCfg
* The pointer to a structure containing static configuration data for the ADC.
*
* \return
* Status of initialization, \ref cy_en_autanalog_status_t.
*
...
* and configured in cy_stc_autanalog_sar_limit_t::limitCond.
*
* \param sarIdx
* The index of the ADC subsystem within the Autonomous Analog,
* see \ref cy_stc_autanalog_cfg_t::sar.
...
* and reached the averaging count (in the case of interleaved averaging).
*
* \param sarIdx
* The index of the ADC subsystem within the Autonomous Analog,
* see \ref cy_stc_autanalog_cfg_t::sar.
...
* \note Only the first eight channels of the ADC can be corrected.
*
* \param sarIdx
* The index of the ADC subsystem within the Autonomous Analog,
* see \ref cy_stc_autanalog_cfg_t::sar.
...
* for the first eight channels of the ADC.
*
...
* (i.e. the next state in a scan is set to cy_en_autanalog_sar_next_act_t::CY_AUTANALOG_SAR_NEXT_ACTION_GO_TO_ENTRY_ADDR).
...
* (\ref Cy_AutAnalog_FIFO_ReadData, \ref Cy_AutAnalog_FIFO_ReadDataChanId).
*
* \return
...
*
* \note The die temperature measurement only works for MUX channels in single-ended configuration
* with the negative input of the ADC connected to Vss
* and the positive input of the ADC connected to the temperature sensor.

* \note The averaging can be activated to reduce noise.
* However, the averaging configuration settings will specify a 12-bit resolution
* for the ADC output in the result.
*
* \param sarIdx
* The index of the ADC subsystem within the Autonomous Analog,
* see \ref cy_stc_autanalog_cfg_t::sar.
...
* \param VrefmV
* The ADC reference voltage in mV.
* \note Vbgr should be used as reference voltage when measuring the die temperature.
*
* \param sarCounts
* The conversion result, see \ref Cy_AutAnalog_SAR_ReadResult.
* If conversion data is received from FIFO, see \ref Cy_AutAnalog_FIFO_ReadWord
...
int16_t Cy_AutAnalog_SAR_CountsTo_degreeC(uint8_t sarIdx, bool sarLP, uint8_t sarSequencer, uint8_t sarChannel,
                                       uint32_t VrefmV, int32_t sarCounts);
...
*
*******************************************************************************/
uint16_t Cy_AutAnalog_FIFO_ReadData(uint8_t fifoIdx, uint8_t buffIdx, int32_t * data);
