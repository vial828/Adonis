...
*
* The diagram below shows the PTComp simplified internals.
*
...
*
* \image html LPPASS_PTC_general.png
*
...
typedef enum
{
    CY_AUTANALOG_PTCOMP_COMP_COREIO0   = 0UL,  /**< The Comp input connected to CTBL0 GPIO Pin 1 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO1   = 1UL,  /**< The Comp input connected to CTBL0 GPIO Pin 4 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO2   = 2UL,  /**< The Comp input connected to CTBL0 GPIO Pin 6 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO3   = 3UL,  /**< The Comp input connected to CTBL0 GPIO Pin 7 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO4   = 4UL,  /**< The Comp input connected to CTBL1 GPIO Pin 1 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO5   = 5UL,  /**< The Comp input connected to CTBL1 GPIO Pin 4 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO6   = 6UL,  /**< The Comp input connected to CTBL1 GPIO Pin 6 */
    CY_AUTANALOG_PTCOMP_COMP_COREIO7   = 7UL,  /**< The Comp input connected to CTBL1 GPIO Pin 7 */
    CY_AUTANALOG_PTCOMP_COMP_CTBL0_OA0 = 8UL,  /**< The Comp input connected to CTBL0 OA0 output */
    CY_AUTANALOG_PTCOMP_COMP_CTBL0_OA1 = 9UL,  /**< The Comp input connected to CTBL0 OA1 output */
    CY_AUTANALOG_PTCOMP_COMP_CTBL1_OA0 = 10UL, /**< The Comp input connected to CTBL1 OA0 output */
    CY_AUTANALOG_PTCOMP_COMP_CTBL1_OA1 = 11UL, /**< The Comp input connected to CTBL1 OA1 output */
    CY_AUTANALOG_PTCOMP_COMP_VREF0     = 12UL, /**< The Comp input connected to VREF0 (from CT DAC0)*/
    CY_AUTANALOG_PTCOMP_COMP_VREF1     = 13UL, /**< The Comp input connected to VREF1 (from CT DAC1) */
    CY_AUTANALOG_PTCOMP_COMP_VREF2     = 14UL, /**< The Comp input connected to VREF2 (from PRB0) */
    CY_AUTANALOG_PTCOMP_COMP_VREF3     = 15UL, /**< The Comp input connected to VREF3 (from PRB1) */
