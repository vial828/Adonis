...
*
* The diagram below shows the CTB simplified internals.
*
...
*
* \image html LPPASS_CTB_general.png
*
...
*
* \section group_autanalog_ctb_LNFE LNFE (BJT)
*
* The CTB contains a pair of LNFEs (one for each Opamp), which is an NPN transistor that acts as a bootstrapping element
* to reduce the Opamp input-referred noise.
* The base and emitter connections of each LNFE are configurable in the switch routing matrix.
* For the configuration settings, see \ref cy_en_autanalog_ctb_oa_inv_pin_t and \ref cy_en_autanalog_ctb_oa_mux_out_t.
*
...
*
* \section group_autanalog_ctb_sample1 Sample use case: PGA and Comparator
*
...
*
* \section group_autanalog_ctb_sample2 Sample use case: TIA and Voltage follower
*
* \image html LPPASS_CTB_TIA_Buff.png
*
* \snippet autanalog/snippet/autanalog_ctb.c SNIPPET_CTB_CONFIG_COMMON
*
* \snippet autanalog/snippet/autanalog_ctb.c SNIPPET_CTB_CONFIG_TIA_BUFF
*
...
* \snippet autanalog/snippet/autanalog_ctb.c SNIPPET_CTB_INIT_COMMON
*
* \snippet autanalog/snippet/autanalog_ctb.c SNIPPET_CTB_INIT_TIA_BUFF
*
...
typedef enum
{
    ...
    CY_AUTANALOG_CTB_OA_NINV_REF_VREF0       = 1UL, /**< The non-inverting input is connected to VREF0 (from CT DAC) */
    CY_AUTANALOG_CTB_OA_NINV_REF_VREF1       = 2UL, /**< The non-inverting input is connected to VREF1 (from CT DAC */
    CY_AUTANALOG_CTB_OA_NINV_REF_VREF2       = 3UL, /**< The non-inverting input is connected to VREF2 (from PRB) */
    CY_AUTANALOG_CTB_OA_NINV_REF_VREF3       = 4UL, /**< The non-inverting input is connected to VREF3 (from PRB) */
...
* the pin or LNFE (based on the BJT) using the switch routing matrix.
* For more details, refer to the device Architecture Technical Reference Manual.
*/
typedef enum
{
    ...
    CY_AUTANALOG_CTB_OA_INV_PIN_OA0_P1_OA1_P4 = 2UL, /**< The inverting inputs of the Opamps OA0, OA1
                                                      *   are connected to P1 and P4 respectively
                                                      */
    CY_AUTANALOG_CTB_OA_INV_PIN_BJT           = 3UL, /**< The inverting inputs of the Opamps OA0, OA1
                                                       *  are connected to the base pin of the BJT
                                                       *  using P0 and P5 respectively */
...
typedef enum
{
    ...
    CY_AUTANALOG_CTB_OA_RES_REF_VREF0        = 1UL, /**< The bottom end of the resistor ladder is connected to
                                                     *   VREF0 (from CT DAC) */
    CY_AUTANALOG_CTB_OA_RES_REF_VREF1        = 2UL, /**< The bottom end of the resistor ladder is connected to
                                                     *   VREF1 (from CT DAC) */
    CY_AUTANALOG_CTB_OA_RES_REF_CTBL_OA0_OUT = 3UL, /**< The bottom end of the resistor ladder is connected to
                                                     *   the output of the adjacent CTB OA0 */
    CY_AUTANALOG_CTB_OA_RES_REF_CTBL_OA1_OUT = 4UL, /**< The bottom end of the resistor ladder is connected to
...
/**
* The CTB subsystem allows the Opamp inputs or the bottom end of the resistor ladder or the LNFE
...
typedef enum
{
    ...
    CY_AUTANALOG_CTB_OA_MUX_OUT_BJT        = 4UL, /**< The LNFE is routed to the Opamps inverting input */
...
typedef struct
{
    ...
    cy_en_autanalog_ctb_oa_fb_cap_t capFbOpamp1;    /**< The Edge-detect comparator mode for Opamp1 */
...
typedef struct
{
    ...
    cy_en_autanalog_ctb_oa_inv_pin_t  invInpPin;    /**< Connection of the inverting input of the Opamp to pin or LNFE */
