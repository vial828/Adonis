...
* \image html LPPASS_Infra_general.png
*
...
* 2. Switch to the Peripherals tab. Enable the Autonomous Analog personality under the Analog category
* 3. Select the clock source for the Autonomous Analog, according to the intended operating mode
*    (Low Power vs High Speed)
*    \note The Autonomous Analog requires Clk_HF9, 80 MHz MAX for proper operation.
* 4. Preserve the use of the appropriate pins for the required subsystems of the Autonomous Analog
* 5. Enable the control of the digital outputs (if required)
* 6. Enable the trigger outputs (if required)
* 7. Enable the trigger inputs (if required)
* 8. Launch the Device Configurator for the Autonomous Analog for further configuration
*
...
#define CY_AUTANALOG_INT_CTBL0_COMP0      (LPPASS_MMIO_INTR_CAUSE_CTBL0_COMP0_INT_Msk)     /**< CTB0 COMP0 interrupt */
#define CY_AUTANALOG_INT_CTBL0_COMP1      (LPPASS_MMIO_INTR_CAUSE_CTBL0_COMP1_INT_Msk)     /**< CTB0 COMP1 interrupt */
#define CY_AUTANALOG_INT_CTBL1_COMP0      (LPPASS_MMIO_INTR_CAUSE_CTBL1_COMP0_INT_Msk)     /**< CTB1 COMP0 interrupt */
#define CY_AUTANALOG_INT_CTBL1_COMP1      (LPPASS_MMIO_INTR_CAUSE_CTBL1_COMP1_INT_Msk)     /**< CTB1 COMP1 interrupt */
...
#define CY_AUTANALOG_INTR                 (CY_AUTANALOG_INT_CTBL0_COMP0      | \
...
* - CTBLs, SAR, FIRs and the DACs loose all configuration\n
...
* \note This function also enables the IP block and loads trimming values for the subsystems.
*
* \param analogCfg
