...
typedef struct
{
    ...
    cy_en_sdio_dev_manf_id_config_t            use_default_manfid;    /**< SDIO Device manufacturer ID configuration. If this field is set to
                                             ...
                                             manufacturer ID using manfid field. Otherwise, default manufacturer ID. */
    ...
    cy_en_sdio_dev_blk_size_config_t                    blk_size;                 /**< This field specifies the block size user for function 2 data transfers.
...
****************************************************************************//**
*
* This API will initialize MXSDIO IP with the configuration parameters
*
* \param base
