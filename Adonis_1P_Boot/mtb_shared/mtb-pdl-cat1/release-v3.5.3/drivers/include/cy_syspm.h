...
/**
* \note
* This macro is available for CAT1A and CAT1B(BOY2) devices.
**/
...
#if (defined (CY_IP_MXS40SRSS) && (CY_IP_MXS40SRSS_VERSION < 3)) || defined (CY_IP_MXS22SRSS) || (defined (CY_IP_MXS40SSRSS) && (CY_MXS40SSRSS_VER_1_2 > 0UL)) ||defined (CY_DOXYGEN)
    CY_SYSPM_LP             = 3U,    /**< The Low Power enum callback type, This Macro is available only for CAT1A, CAT1B(BOY2) devices */
    CY_SYSPM_ULP            = 4U,     /**< The Ultra Low Power enum callback type, This Macro is available only for CAT1A, CAT1B(BOY2) devices  */
#endif
...
#endif
#if defined (CY_IP_MXS40SSRSS) && (CY_MXS40SSRSS_VER_1_2 > 0UL)
    CY_SYSPM_MF             = 7U,     /**< The Medium Frequency mode enum callback type, This Macro is available only for CAT1B(Boy2) devices */
#endif

#if defined (CY_IP_MXS40SSRSS) && (CY_MXS40SSRSS_VER_1_2 > 0UL)
    CY_SYSPM_OD             = 8U,     /**< The Over drive Frequency enum callback type, This Macro is available only for  CAT1B(Boy2) devices */
#endif
...
*
* \note
* This API is available for CAT1A, CAT1B(BOY2) and CAT1D devices.
*
*******************************************************************************/
...
*
* \note
* This API is available for CAT1A, CAT1B(BOY2) & CAT1D devices.
*
* \funcusage
...
*
* \note
* This API is available only for CAT1B(BOY2) devices.
*
* \funcusage
...
*
* \note
* This API is available for CAT1B(BOY2) devices.
*
* \funcusage
...
#if (defined (CY_IP_MXS40SRSS) && (CY_IP_MXS40SRSS_VERSION < 3)) || (defined (CY_IP_MXS40SSRSS) && (CY_MXS40SSRSS_VER_1_2 > 0UL)) || defined (CY_DOXYGEN)
...
*
* \note
* This API is available for CAT1A, CAT1B(BOY2) devices.
*
* \funcusage
...
* \{
*/
#if (defined (CY_IP_MXS40SRSS) && (CY_IP_MXS40SRSS_VERSION >= 3)) || (defined (CY_IP_MXS40SSRSS) && (SRSS_S40S_REGSETA_PRESENT == 1UL))
...
*
* \note
* This API is available for CAT1B(Boy2) devices only.
*
* \funcusage
...
* \{
*/
#if (defined (CY_IP_MXS40SRSS) && (CY_IP_MXS40SRSS_VERSION < 3)) || (defined (CY_IP_MXS40SSRSS) && (CY_MXS40SSRSS_VER_1_2 > 0UL))
...
#endif /* CY_IP_MXS40SRSS, CY_IP_MXS40SSRSS && (SRSS_BACKUP_VBCK_PRESENT == 1UL)*/
