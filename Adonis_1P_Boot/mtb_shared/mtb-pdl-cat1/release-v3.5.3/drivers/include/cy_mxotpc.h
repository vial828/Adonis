...
*
*  \param enable
*  Contains value to enable or disable the OTPPROG_EN bit of OTP_CTL
*
*******************************************************************************/
__STATIC_INLINE void Cy_MXOTPC_OtpProgEnable(bool enable)
{
...
****************************************************************************//**
*
* Write the OTP_CMD register with row/column addresses and command type along
...
*
*  \param otpData
*  Contains value to be written in to OTP_PROGDATA Register.
*
*******************************************************************************/
__STATIC_INLINE void Cy_MXOTPC_OtpSetProgData(uint32_t otpData)
{
...
*
*  \param mask
*  Contains mask value to enable a particular lock region on CC312_RGN_LOCK_CTL register.
*
*******************************************************************************/
