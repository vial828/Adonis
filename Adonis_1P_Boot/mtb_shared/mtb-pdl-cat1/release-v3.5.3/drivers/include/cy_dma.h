...
*   <tr>
*     <td>2.80</td>
*     <td>Updated \ref Cy_DMA_GetActiveChannel.</td>
*     <td>Bug fix.</td>
*   </tr>
*   <tr>
*     <td>2.70</td>
...
#if (defined (CY_IP_M4CPUSS_DMA) && (CY_IP_M4CPUSS_DMA_VERSION >= 1u)) || defined (CY_IP_MXDW) || defined (CY_IP_M7CPUSS_DMA)
...
* returns "1" if atleast one channel is in active state, otherwise "0" since this
* version of IP can support more than 32 channels. To know IP version for the device
* under use prefer refer <a href="usergroup1.html">Device Catalog</a>.
*
* \funcusage
* \snippet dma/snippet/main.c snippet_Cy_DMA_Disable
*
...
__STATIC_INLINE uint32_t Cy_DMA_GetActiveChannel(DW_Type const * base)
{
    ...
    /* Return 1 in case there is an ACTIVE channel or else 0 */
    return (_FLD2VAL(DW_STATUS_ACTIVE, DW_STATUS(base)));
#endif
