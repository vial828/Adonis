...
*
* This driver is only available for CAT1D devices.
*
...
#define CY_RRAM_OPERATION_TIMEOUT               (800UL)        /* Max time required for write to complete is 800us */
...
/* Application can overwrite this to avoid depending on DLT app */
...
typedef enum
{
    CY_RRAM_ECC_READ_NO_FAIL                  = 0x00000000UL,  /**< Read is success without any ECC fail */
    CY_RRAM_ECC_READ_SINGLE_BIT_FAIL          = 0x00000080UL,  /**< At least one ECC single-bit failure was detected and corrected during the last memory read operation */
    CY_RRAM_ECC_READ_DOUBLE_BIT_FAIL          = 0x00000100UL,  /**< At least one ECC double-bit failure was detected and corrected during the last memory read operation */
    CY_RRAM_ECC_READ_TRIPLE_BIT_FAIL          = 0x00000200UL,  /**< At least one ECC triple-bit failure was detected and corrected during the last memory read operation */
    CY_RRAM_ECC_READ_MULTIPLE_BIT_FAIL        = 0x00000400UL,  /**< At least one ECC-uncorrectable multi-bit failure was detected during the last memory read operation */
    CY_RRAM_ECC_READ_ADDRESS_MISMATCH         = 0x00000800UL,  /**< At least one address mismatch ECC failure was detected during the last memory read operation */
    CY_RRAM_ECC_READ_BLOCK_SINGLE_BIT_FAIL    = 0X00010000UL,  /**< An ECC single-bit failure was detected and corrected during the most recent memory read operation to a new block */
    CY_RRAM_ECC_READ_BLOCK_DOUBLE_BIT_FAIL    = 0X00020000UL,  /**< An ECC double-bit failure was detected and corrected during the most recent memory read operation to a new block */
    CY_RRAM_ECC_READ_BLOCK_TRIPLE_BIT_FAIL    = 0X00040000UL,  /**< An ECC triple-bit failure was detected and corrected during the most recent memory read operation to a new block */
    CY_RRAM_ECC_READ_BLOCK_MULTIPLE_BIT_FAIL  = 0X00080000UL,  /**< An ECC-uncorrectable multi-bit failure was detected during the most recent memory read operation to a new block */
    CY_RRAM_ECC_READ_BLOCK_ADDRESS_MISMATCH   = 0x00100000UL   /**< An address mismatch ECC failure was detected during the most recent memory read operation to a new block */
} cy_en_rram_ecc_status_t;
