...
*
* The diagram below shows the CT DAC simplified internals.
*
...
*
* \image html LPPASS_DAC_general.png
*
...
*    </tr>
* </table>
* For the configuration settings, see \ref cy_en_autanalog_dac_buf_pwr_t.
*
...
#define CY_AUTANALOG_DAC_CHAN_MASK0                    (0x00000001UL) /**< The DAC channel 0 */
#define CY_AUTANALOG_DAC_CHAN_MASK1                    (0x00000002UL) /**< The DAC channel 1 */
#define CY_AUTANALOG_DAC_CHAN_MASK2                    (0x00000004UL) /**< The DAC channel 2 */
#define CY_AUTANALOG_DAC_CHAN_MASK3                    (0x00000008UL) /**< The DAC channel 3 */
#define CY_AUTANALOG_DAC_CHAN_MASK4                    (0x00000010UL) /**< The DAC channel 4 */
#define CY_AUTANALOG_DAC_CHAN_MASK5                    (0x00000020UL) /**< The DAC channel 5 */
#define CY_AUTANALOG_DAC_CHAN_MASK6                    (0x00000040UL) /**< The DAC channel 6 */
#define CY_AUTANALOG_DAC_CHAN_MASK7                    (0x00000080UL) /**< The DAC channel 7 */
#define CY_AUTANALOG_DAC_CHAN_MASK8                    (0x00000100UL) /**< The DAC channel 8 */
#define CY_AUTANALOG_DAC_CHAN_MASK9                    (0x00000200UL) /**< The DAC channel 9 */
#define CY_AUTANALOG_DAC_CHAN_MASK10                   (0x00000400UL) /**< The DAC channel 10 */
#define CY_AUTANALOG_DAC_CHAN_MASK11                   (0x00000800UL) /**< The DAC channel 11 */
#define CY_AUTANALOG_DAC_CHAN_MASK12                   (0x00001000UL) /**< The DAC channel 12 */
#define CY_AUTANALOG_DAC_CHAN_MASK13                   (0x00002000UL) /**< The DAC channel 13 */
#define CY_AUTANALOG_DAC_CHAN_MASK14                   (0x00004000UL) /**< The DAC channel 14 */
...
/**
 * Defines Power mode for the reference buffer and the output buffer.
...
typedef enum
{
    CY_AUTANALOG_DAC_BUF_PWR_OFF             =  0UL, /**< The power mode for the buffer is OFF,\n
                                                      *   the buffer is disabled */
    CY_AUTANALOG_DAC_BUF_PWR_ULTRA_LOW       =  1UL, /**< The power mode for the buffer is ULTRA LOW,\n
                                                      *   the charge pump is OFF\n
                                                      *   and the buffer quiescent current is 15uA.
                                                      ...
                                                      *      and the output drive capability is 10uA; */
    CY_AUTANALOG_DAC_BUF_PWR_ULTRA_LOW_RAIL  =  2UL, /**< The power mode for the buffer is ULTRA LOW,\n
                                                      *   the charge pump is ON\n
                                                      *   and the buffer quiescent current is 35uA.
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is INTERNAL\n
                                                      *      the gain bandwidth is 30kHz;\n
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is EXTERNAL\n
                                                      *      the gain bandwidth is 100kHz;\n
                                                      *      and the output drive capability is 10uA; */
    CY_AUTANALOG_DAC_BUF_PWR_LOW_RAIL        =  4UL, /**< The power mode for the buffer is LOW,\n
                                                      *   the charge pump is ON\n
                                                      *   and the buffer quiescent current is 150uA.
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is INTERNAL\n
                                                      *      the gain bandwidth is 350kHz;\n
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is EXTERNAL\n
                                                      *      the gain bandwidth is 1.2MHz;\n
                                                      *      and the output drive capability is 100uA; */
    CY_AUTANALOG_DAC_BUF_PWR_MEDIUM_RAIL     =  6UL, /**< The power mode for the buffer is MEDIUM,\n
                                                      *   the charge pump is ON\n
                                                      *   and the buffer quiescent current is 200uA.
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is INTERNAL\n
                                                      *      the gain bandwidth is 700kHz;\n
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is EXTERNAL\n
                                                      *      the gain bandwidth is 2.4MHz;\n
                                                      *      and the output drive capability is 1mA; */
    CY_AUTANALOG_DAC_BUF_PWR_HIGH_RAIL       =  8UL, /**< The power mode for the buffer is HIGH,\n
                                                      *   the charge pump is ON\n
                                                      *   and the buffer quiescent current is 600uA.
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is INTERNAL\n
                                                      *      the gain bandwidth is 1.75MHz;\n
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is EXTERNAL\n
                                                      *      the gain bandwidth is 6MHz;\n
                                                      *      and the output drive capability is 1mA; */
    CY_AUTANALOG_DAC_BUF_PWR_ULTRA_HIGH_RAIL = 10UL, /**< The power mode for the buffer is ULTRA HIGH,\n
                                                      *   the charge pump is ON\n
                                                      *   and the buffer quiescent current is 800uA.
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is INTERNAL\n
                                                      *      the gain bandwidth is 2.8MHz;\n
                                                      *   If cy_stc_autanalog_dac_sta_t::outBuffPwr is EXTERNAL\n
                                                      *      the gain bandwidth is 7.5MHz;\n
                                                      *      and the output drive capability is 10mA; */
} cy_en_autanalog_dac_buf_pwr_t;
...
typedef enum
{
    ...
    CY_AUTANALOG_DAC_VREF_MUX_PRB_VREF0 = 6UL, /**< The DAC reference is Vref0 from the PRB */
    CY_AUTANALOG_DAC_VREF_MUX_PRB_VREF1 = 7UL, /**< The DAC reference is Vref1 from the PRB */
...
typedef enum
{
    CY_AUTANALOG_DAC_CH_LIMIT_BELOW   = 0UL, /**< The DAC Value/Address must satisfy the following:\n
                                              *   Value < cy_stc_autanalog_dac_ch_limit_t::low */
    CY_AUTANALOG_DAC_CH_LIMIT_INSIDE  = 1UL, /**< The DAC Value/Address must satisfy the following:\n
                                              *   (cy_stc_autanalog_dac_ch_limit_t::low <= Value/Address) AND
                                              *   (Value/Address < cy_stc_autanalog_dac_ch_limit_t::high) */
    CY_AUTANALOG_DAC_CH_LIMIT_ABOVE   = 2UL, /**< The DAC Value/Address must satisfy the following:\n
                                              *   Value > cy_stc_autanalog_dac_ch_limit_t::high */
    CY_AUTANALOG_DAC_CH_LIMIT_OUTSIDE = 3UL, /**< The DAC Value/Address must satisfy the following:\n
...
typedef struct
{
    ...
    bool                              disabledMode;                             /**< The selector for the DAC output value
                                                                                 ...
                                                                                 *     field;
                                                                                 */
    cy_en_autanalog_dac_buf_pwr_t     refBuffPwr;                               /**< The power mode of the
                                                                                 *   reference voltage buffer,
                                                                                 *   for more details, refer to
                                                                                 *   \ref group_autanalog_dac_topology
                                                                                 *   chapter */
    cy_en_autanalog_dac_buf_pwr_t     outBuffPwr;                               /**< The power mode of the
