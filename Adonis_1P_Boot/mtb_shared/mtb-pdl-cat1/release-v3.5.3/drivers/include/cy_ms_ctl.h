...
#if defined (CY_IP_M33SYSCPUSS) && (CY_IP_M33SYSCPUSS_VERSION >= 1) || defined(CY_DOXYGEN)
...
#if defined (_CYIP_MS_CTL_2_1_V2_H_) || defined (_CYIP_MS_CTL_2_0_V2_H_) || defined (_CYIP_MS_CTL_1_2_H_)
