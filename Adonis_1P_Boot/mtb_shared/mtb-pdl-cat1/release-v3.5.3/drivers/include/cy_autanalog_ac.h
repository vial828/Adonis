...
* The total number of the states in the STT is 64.
*
...
* The AC supports four (\ref cy_en_autanalog_fw_trigger_t) input triggers (firmware triggers)
* and eight (\ref cy_en_autanalog_ac_out_trigger_idx_t) output triggers.
*
...
typedef enum
{
    ...
    CY_AUTANALOG_STT_AC_ACTION_BRANCH_IF_TRUE      = 3UL,  /**< Check if CONDITION has occurred
                                                            *   If it has, take the indicated branch
...
typedef enum
{
    ...
    CY_AUTANALOG_STT_AC_CONDITION_CTBL0_CMP0           = 22UL, /**< CTBL0 COMP0 output.
                                                                *   This status is sticky.
                                                                *   It is set by the CTBL0 Opamp0 Comparator if the condition is met
                                                                *   (\ref cy_stc_autanalog_ctb_sta_t::intComp0).\n
                                                                *   The status is cleared by the AC when any of the following occur:
                                                                *   1. Executing an AC state where ACTION is set to WAIT_FOR or
                                                                *      BRANCH_IF_* and CONDITION is set to CTBL0_CMP0.
                                                                *   2. Executing an AC state where ACTION is set to WAIT_FOR and
                                                                *      CONDITION is set to any of the *_WAKE.
                                                                *   3. Pausing the AC, see
                                                                *      \ref Cy_AutAnalog_PauseAutonomousControl or
                                                                ...
                                                                *   4. Disabling the AC, see
                                                                *      \ref Cy_AutAnalog_Disable
                                                                *   5. Disabling CTBL0 opamp0
                                                                *      (by clearing cy_stc_autanalog_stt_ctb_t::enableOpamp0)
                                                                *   \note No overflow indication is provided for this bit.
                                                                *   Therefore, it is up to the user to program the AC
                                                                *   to read this status before an overflow occurs
                                                                *   (multiple CTBL0_CMP0s). */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL0_CMP1           = 23UL, /**< CTBL0 COMP1 output. It is similar to CTBL0 COMP0 output. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL1_CMP0           = 24UL, /**< CTBL1 COMP0 output. It is similar to CTBL0 COMP0 output. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL1_CMP1           = 25UL, /**< CTBL1 COMP1 output. It is similar to CTBL0 COMP0 output. */
    ...
    CY_AUTANALOG_STT_AC_CONDITION_TIMER_DONE_WAKE      = 39UL, /**< Timer Wakeup Source.
                                                                ...
                                                                *   are cleared. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL0_CMP0_WAKE      = 40UL, /**< CTBL0 comparator 0 wake-up.
                                                                *   This condition is used to put the AC to sleep.
                                                                *   The AC will wake up when CTBL0 Comparator 0
                                                                ...
                                                                *   The CTBL0 comparator 0 must be enabled during sleep
                                                                *   (\ref cy_stc_autanalog_stt_ctb_t::enableOpamp0).
                                                                *   \note When the AC is sleeping, all registered AC conditions
                                                                *   are cleared. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL0_CMP1_WAKE      = 41UL, /**< CTBL0 comparator 1 wake-up.
                                                                *   It is similar to CTBL0 comparator 0 wake-up. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL1_CMP0_WAKE      = 42UL, /**< CTBL1 comparator 0 wake-up.
                                                                *   It is similar to CTBL0 comparator 0 wake-up. */
    CY_AUTANALOG_STT_AC_CONDITION_CTBL1_CMP1_WAKE      = 43UL, /**< CTBL1 comparator 1 wake-up.
                                                                *   It is similar to CTBL0 comparator 0 wake-up. */
...
typedef enum
{
    ...
    CY_AUTANALOG_AC_OUT_TRIG_MASK_CTBL0_COMP0   =       1UL << 0U,  /**< The CTB0, Comp0 trigger.
                                                                     *   It is generated by the CTBL0 Opamp0 Comparator
                                                                     *   if the condition is met
                                                                     *   (i.e. \ref cy_stc_autanalog_ctb_sta_t::intComp0)*/
    CY_AUTANALOG_AC_OUT_TRIG_MASK_CTBL0_COMP1   =       1UL << 1U,  /**< The CTB0, Comp1 trigger.
                                                                     *   It is generated by the CTBL0 Opamp1 Comparator
                                                                     *   if the condition is met
                                                                     *   (i.e. \ref cy_stc_autanalog_ctb_sta_t::intComp1)*/
    CY_AUTANALOG_AC_OUT_TRIG_MASK_CTBL1_COMP0   =       1UL << 2U,  /**< The CTB1, Comp0 trigger.
                                                                     *   It is similar to CTB0, Comp0 trigger. */
    CY_AUTANALOG_AC_OUT_TRIG_MASK_CTBL1_COMP1   =       1UL << 3U,  /**< The CTB1, Comp1 trigger.
...
typedef struct
{
    bool                               unlock;        /**< AC Unlock:
                                                       *  - FALSE - Locked:\n
                                                       *    Data from the remaining fields
