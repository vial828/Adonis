...
#define CY_I3C_CONTROLLER_ERR_EVENT                   (CY_I3C_CRC_ERROR_EVENT| CY_I3C_PARITY_ERROR_EVENT| CY_I3C_FRAME_ERROR_EVENT| \
                                                   ...
                                                   CY_I3C_XFER_ABORTED_ERROR_EVENT| CY_I3C_I2C_TGT_WDATA_NACK_ERROR_EVENT| CY_I3C_CONTROLLER_ERROR_CE0 )
...
#define CY_I3C_TARGET_ERR_EVENT                    (CY_I3C_CRC_ERROR_EVENT| CY_I3C_PARITY_ERROR_EVENT| CY_I3C_FRAME_ERROR_EVENT| \
                                                   CY_I3C_BUFFER_OVERFLOW_ERROR_EVENT | CY_I3C_CONTROLLER_EARLY_TERMINATION_EVENT)

/** The target device is assigned a dynamic address through SETDASA or ENTDAA CCC from the controller */
...
/** CY_I3C_TARGET_RD_BUF_EMPTY_EVENT */
#define CY_I3C_TARGET_RD_BUF_EMPTY_EVENT    (0x00004000UL)
...
typedef enum
{
    ...
    */
    ...
    /** In Target mode of operation, the Controller has disabled SIR through DISEC */
