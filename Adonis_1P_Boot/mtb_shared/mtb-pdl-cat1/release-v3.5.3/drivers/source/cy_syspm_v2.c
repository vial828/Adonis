    ...
    else
    {
        ...
        if (retVal == CY_SYSPM_SUCCESS)
        {
            ...
            */
            ...
            if(Cy_SysClk_PllIsEnabled(0U))
            {
                (void)Cy_SysClk_PllDisable(0U); /* Suppress a compiler warning about unused return value */
            }
...
cy_en_syspm_status_t Cy_SysPm_SystemLpActiveExit(void)
{
    ...
    if (retVal == CY_SYSPM_SUCCESS)
    {
        ...
        */
        ...
        #if (defined (SRSS_NUM_TOTAL_PLL) && (SRSS_NUM_TOTAL_PLL > 0UL))
        if (CY_SYSCLK_SUCCESS != Cy_SysClk_PllEnable(0UL, 10000u))
        {
            retVal = CY_SYSPM_FAIL;
        }
    ...
    */
    if (retVal == CY_SYSPM_SUCCESS)
    {
        ...
        */
        ...
        if (Cy_SysPm_LdoIsEnabled()) // Comment : Is this check req for BOY2
        {
            /* Current active regulator is LDO */
            if (Cy_SysPm_LdoGetVoltage() != CY_SYSPM_LDO_VOLTAGE_LP)
            {
