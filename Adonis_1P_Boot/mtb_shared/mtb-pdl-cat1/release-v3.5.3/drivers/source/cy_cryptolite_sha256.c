                                        ...
                                        cy_stc_cryptolite_context_sha256_t *cfContext)
{
    ...
    while((cfContext->msgIdx + lmessageSize) >= CY_CRYPTOLITE_SHA256_BLOCK_SIZE)
    {
        ...
        err = Cy_Cryptolite_Memcpy(base, &cfContext->message[cfContext->msgIdx], (uint8_t *)&message[readIdx], tocopy); 
    ...
    err = Cy_Cryptolite_Memcpy(base, &cfContext->message[cfContext->msgIdx], (uint8_t *)&message[readIdx], lmessageSize);
