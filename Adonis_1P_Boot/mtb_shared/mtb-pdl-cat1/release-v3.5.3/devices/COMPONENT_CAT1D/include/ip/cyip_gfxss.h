...
typedef struct {
  ...
  __IOM uint32_t AQMEMORYFEPAGETABLE;           /*!< 0x00000400 Fetch Engine Page Table Base Address Register. */
...
/* GFXSS_GPU_GCNANO.AQMEMORYFEPAGETABLE */
#define GFXSS_GPU_GCNANO_AQMEMORYFEPAGETABLE_AQMEMORYFEPAGETABLE_RESERVED_Pos 0UL
#define GFXSS_GPU_GCNANO_AQMEMORYFEPAGETABLE_AQMEMORYFEPAGETABLE_RESERVED_Msk 0xFFFUL
#define GFXSS_GPU_GCNANO_AQMEMORYFEPAGETABLE_AQMEMORYFEPAGETABLE_BASE_ADDRESS_Pos 12UL
#define GFXSS_GPU_GCNANO_AQMEMORYFEPAGETABLE_AQMEMORYFEPAGETABLE_BASE_ADDRESS_Msk 0xFFFFF000UL
