...
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_SECTION_SIZE 0x00002000UL
...
/**
  * \brief PROTECTED_OTP subregion (8KB) (RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0)
  */
typedef struct {
  __IOM uint32_t BOOTROW[4];                    /*!< 0x00000000 N/A */
  __IOM uint32_t UDS[48];                       /*!< 0x00000010 N/A */
  __IOM uint32_t DICE_DEVICEID_PRIVATE_KEY[25]; /*!< 0x000000D0 N/A */
   __IM uint32_t WRAPPING_MASTER_KEY[25];       /*!< 0x00000134 N/A */
  __IOM uint32_t HUK[25];                       /*!< 0x00000198 N/A */
  __IOM uint32_t RESERVED1;                     /*!< 0x000001FC N/A */
  __IOM uint32_t DEV_DEVICE[5];                 /*!< 0x00000200 N/A */
  __IOM uint32_t IFX_ROT_KEY_01[36];            /*!< 0x00000214 N/A */
  __IOM uint32_t IFX_RMA_MASTER_KEY_01[36];     /*!< 0x000002A4 N/A */
  __IOM uint32_t PRODUCTION_OEM_ROT_KEY_01[39]; /*!< 0x00000334 N/A */
  __IOM uint32_t IFX_ROT_KEY_REV[4];            /*!< 0x000003D0 N/A */
  __IOM uint32_t IFX_RMA_MASTER_KEY_REV[4];     /*!< 0x000003E0 N/A */
  __IOM uint32_t OEM_ROT_KEY_REV[4];            /*!< 0x000003F0 N/A */
  __IOM uint32_t RAM_APP_NV_COUNTER[4];         /*!< 0x00000400 N/A */
  __IOM uint32_t PROTECTED_NVM_LOCKABLE[2];     /*!< 0x00000410 N/A */
  __IOM uint32_t ASSET_HASH[8];                 /*!< 0x00000418 N/A */
  __IOM uint32_t BASE_SE_RT_SERVICES_HASH[8];   /*!< 0x00000438 N/A */
  __IOM uint32_t FACTORY_HASH[8];               /*!< 0x00000458 N/A */
  __IOM uint32_t IFX_POLICY[2];                 /*!< 0x00000478 N/A */
  __IOM uint32_t DICE_DEVICEID_PUBLIC_KEY[18];  /*!< 0x00000480 N/A */
  __IOM uint32_t IFX_REVOCATION_KEY[18];        /*!< 0x000004C8 N/A */
  __IOM uint32_t IFX_FW_INTEGRITY_KEY_01[36];   /*!< 0x00000510 N/A */
  __IOM uint32_t IFX_FW_ENCRYPTION_KEY_01[52];  /*!< 0x000005A0 N/A */
  __IOM uint32_t IFX_FW_INTEGRITY_KEY_REV[4];   /*!< 0x00000670 N/A */
  __IOM uint32_t IFX_ENCRYPTION_KEY_REV[4];     /*!< 0x00000680 N/A */
  __IOM uint32_t IFX_SE_RT_SERVICES_NV_COUNTER[4]; /*!< 0x00000690 N/A */
  __IOM uint32_t UDS_NV_COUNTER[4];             /*!< 0x000006A0 N/A */
  __IOM uint32_t PRODUCTION_CM33_L1_BOOT_HASH[8]; /*!< 0x000006B0 N/A */
  __IOM uint32_t PRODUCTION_REPROVISIONING_POLICY[9]; /*!< 0x000006D0 N/A */
  __IOM uint32_t RESERVED2[579];                /*!< 0x000006F4 N/A */
  __IOM uint32_t OEM_NV_COUNTER[16];            /*!< 0x00001000 N/A */
   __IM uint32_t RESERVED[1008];
} RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_Type; /*!< Size = 8192 (0x2000) */

/**
  * \brief RRAM OTP map and Extra region (RRAMC_RRAM_EXTRA_AREA)
  */
typedef struct {
        RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_Type PROTECTED_OTP_DATA_1_0; /*!< 0x00000000 PROTECTED_OTP subregion (8KB) */
   __IM uint32_t RESERVED[2048];
  __IOM uint32_t GENERAL_OTP[1408];             /*!< 0x00004000 GENERAL_OTP subregion (5.5KB) */
   __IM uint32_t RESERVED1[2688];
   __IM uint32_t SRAM_REPAIR_OTP[128];          /*!< 0x00008000 SRAM_REPAIR_OTP subregion (0.5K) */
   __IM uint32_t RESERVED2[384];
  __IOM uint32_t MANAGEMENT_REGION[512];        /*!< 0x00008800 RRAM management region (2KB, a.k.a. configuration space) */
   __IM uint32_t RESERVED3[7168];
...
typedef struct {
  ...
  __IOM uint32_t NVM_WCAADDR;                   /*!< 0x00000040 write counter array (WCA) address register, fpga_g = 1 */
  __IOM uint32_t NVM_WCADATA;                   /*!< 0x00000044 write counter array (WCA) data register, fpga_g = 1 */
  __IOM uint32_t NVM_EOLISET;                   /*!< 0x00000048 end of life imitation setup register, fpga_g = 1 */
...
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.BOOTROW */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_BOOTROW_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_BOOTROW_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.UDS */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_UDS_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_UDS_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.DICE_DEVICEID_PRIVATE_KEY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DICE_DEVICEID_PRIVATE_KEY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DICE_DEVICEID_PRIVATE_KEY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.WRAPPING_MASTER_KEY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_WRAPPING_MASTER_KEY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_WRAPPING_MASTER_KEY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.HUK */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_HUK_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_HUK_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.RESERVED1 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RESERVED1_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RESERVED1_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.DEV_DEVICE */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DEV_DEVICE_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DEV_DEVICE_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_ROT_KEY_01 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ROT_KEY_01_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ROT_KEY_01_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_RMA_MASTER_KEY_01 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_RMA_MASTER_KEY_01_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_RMA_MASTER_KEY_01_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.PRODUCTION_OEM_ROT_KEY_01 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_OEM_ROT_KEY_01_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_OEM_ROT_KEY_01_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_ROT_KEY_REV */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ROT_KEY_REV_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ROT_KEY_REV_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_RMA_MASTER_KEY_REV */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_RMA_MASTER_KEY_REV_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_RMA_MASTER_KEY_REV_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.OEM_ROT_KEY_REV */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_OEM_ROT_KEY_REV_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_OEM_ROT_KEY_REV_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.RAM_APP_NV_COUNTER */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RAM_APP_NV_COUNTER_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RAM_APP_NV_COUNTER_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.PROTECTED_NVM_LOCKABLE */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PROTECTED_NVM_LOCKABLE_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PROTECTED_NVM_LOCKABLE_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.ASSET_HASH */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_ASSET_HASH_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_ASSET_HASH_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.BASE_SE_RT_SERVICES_HASH */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_BASE_SE_RT_SERVICES_HASH_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_BASE_SE_RT_SERVICES_HASH_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.FACTORY_HASH */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_FACTORY_HASH_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_FACTORY_HASH_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_POLICY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_POLICY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_POLICY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.DICE_DEVICEID_PUBLIC_KEY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DICE_DEVICEID_PUBLIC_KEY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_DICE_DEVICEID_PUBLIC_KEY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_REVOCATION_KEY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_REVOCATION_KEY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_REVOCATION_KEY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_FW_INTEGRITY_KEY_01 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_INTEGRITY_KEY_01_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_INTEGRITY_KEY_01_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_FW_ENCRYPTION_KEY_01 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_ENCRYPTION_KEY_01_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_ENCRYPTION_KEY_01_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_FW_INTEGRITY_KEY_REV */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_INTEGRITY_KEY_REV_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_FW_INTEGRITY_KEY_REV_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_ENCRYPTION_KEY_REV */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ENCRYPTION_KEY_REV_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_ENCRYPTION_KEY_REV_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.IFX_SE_RT_SERVICES_NV_COUNTER */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_SE_RT_SERVICES_NV_COUNTER_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_IFX_SE_RT_SERVICES_NV_COUNTER_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.UDS_NV_COUNTER */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_UDS_NV_COUNTER_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_UDS_NV_COUNTER_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.PRODUCTION_CM33_L1_BOOT_HASH */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_CM33_L1_BOOT_HASH_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_CM33_L1_BOOT_HASH_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.PRODUCTION_REPROVISIONING_POLICY */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_REPROVISIONING_POLICY_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_PRODUCTION_REPROVISIONING_POLICY_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.RESERVED2 */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RESERVED2_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_RESERVED2_DATA32_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0.OEM_NV_COUNTER */
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_OEM_NV_COUNTER_DATA32_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_PROTECTED_OTP_DATA_1_0_OEM_NV_COUNTER_DATA32_Msk 0xFFFFFFFFUL
...
/* RRAMC_RRAM_EXTRA_AREA.SRAM_REPAIR_OTP */
#define RRAMC_RRAM_EXTRA_AREA_SRAM_REPAIR_OTP_SRAM_REPAIR_OTP_VALUE_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_SRAM_REPAIR_OTP_SRAM_REPAIR_OTP_VALUE_Msk 0xFFFFFFFFUL
/* RRAMC_RRAM_EXTRA_AREA.MANAGEMENT_REGION */
#define RRAMC_RRAM_EXTRA_AREA_MANAGEMENT_REGION_EXTAR_REGION_VALUE_Pos 0UL
#define RRAMC_RRAM_EXTRA_AREA_MANAGEMENT_REGION_EXTAR_REGION_VALUE_Msk 0xFFFFFFFFUL
...
/* RRAMC_RRAM_SFR.NVM_WCAADDR */
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRB_Pos   0UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRB_Msk   0xFUL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRWL_Pos  4UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRWL_Msk  0x70UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRS_Pos   7UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ADDRRS_Msk   0x780UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_RSTWCA_Pos   15UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_RSTWCA_Msk   0x8000UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_WCAADDRS_Pos 16UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_WCAADDRS_Msk 0x3FF0000UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ENWBMD_Pos   31UL
#define RRAMC_RRAM_SFR_NVM_WCAADDR_ENWBMD_Msk   0x80000000UL
/* RRAMC_RRAM_SFR.NVM_WCADATA */
#define RRAMC_RRAM_SFR_NVM_WCADATA_WCAV_Pos     0UL
#define RRAMC_RRAM_SFR_NVM_WCADATA_WCAV_Msk     0xFFFFFUL
/* RRAMC_RRAM_SFR.NVM_EOLISET */
#define RRAMC_RRAM_SFR_NVM_EOLISET_LIMIT_Pos    0UL
#define RRAMC_RRAM_SFR_NVM_EOLISET_LIMIT_Msk    0xFFFFFUL
#define RRAMC_RRAM_SFR_NVM_EOLISET_WINC_Pos     20UL
#define RRAMC_RRAM_SFR_NVM_EOLISET_WINC_Msk     0xFF00000UL
#define RRAMC_RRAM_SFR_NVM_EOLISET_ERRDEF_Pos   28UL
#define RRAMC_RRAM_SFR_NVM_EOLISET_ERRDEF_Msk   0xF0000000UL
