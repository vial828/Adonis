...
#define CY_SMIF0_MAIN_NVM_NS_OFFSET 0x00280000
#endif

#ifndef CY_SMIF0_MAIN_NVM_NS_SIZE
#define CY_SMIF0_MAIN_NVM_NS_SIZE 0x04000000-0x00280000
#endif
...
#define CY_SRAM0_SHM_S_OFFSET 0x0003E000
#endif
...
#endif
#ifndef CY_CM33_NSC_ADDR
#define CY_CM33_NSC_ADDR 0x12029f00
#endif
#ifndef CY_CM33_NSC_SIZE
#define CY_CM33_NSC_SIZE 0x00000100
#endif
#ifndef CY_CM33_NS_APP_BOOT_ADDR
#define CY_CM33_NS_APP_BOOT_ADDR 0x60340400
#endif
#ifndef CY_CM55_APP_BOOT_ADDR
...
#define CY_SYSCLK_HF_MAX_FREQ(hfNum)       (400000000U)
...
#define SRSS_DECODED_LCS_DATA               (SRSS_BASE + 0x1D00UL)
...
__STATIC_INLINE uint32_t PERI_DIV_8_NR(uint32_t instNum, uint32_t grNum)
{
...
__STATIC_INLINE uint32_t PERI_DIV_16_NR(uint32_t instNum, uint32_t grNum)
{
    uint32_t divider_num = 0U;
    switch (instNum)
    {
...
__STATIC_INLINE uint32_t PERI_DIV_16_5_NR(uint32_t instNum, uint32_t grNum)
{
    uint32_t divider_num = 0U;
    switch (instNum)
    {
...
__STATIC_INLINE uint32_t PERI_DIV_24_5_NR(uint32_t instNum, uint32_t grNum)
{
    uint32_t divider_num = 0U;
    switch (instNum)
    {
...
#define __CM55_CMSIS_VERSION_5_9 0x00050009U

#if defined (CORE_NAME_CM55_0)
#if (__CM55_CMSIS_VERSION >= __CM55_CMSIS_VERSION_5_9)
...
#define CY_IPC_PIPE_COMPUTE_INTR_MASK(ipcChannel, ipcIntrmask)                   (((ipcChannel)<CY_IPC_CHANNELS_PER_INSTANCE)?(ipcIntrmask):((ipcIntrmask)>>CY_IPC_CHANNELS_PER_INSTANCE))
/* ipcChannel comprises of total number of channels present in all IPC IP instances */
...
/* Reserve Channels are Interrupts for CM0, CM33-S and Cm33-NS */
#define CM0_IPC0_CH_NUM                 (0x2u)
#define CM0_IPC0_CH_MASK                (CY_IPC_CH_MASK(CM0_IPC0_CH_NUM))
#define CM0_IPC0_INTR_NUM               (0x2u)
#define CM0_IPC0_INTR_MASK              (CY_IPC_INTR_MASK(CM0_IPC0_INTR_NUM))
#define CM0_IPC0_INTR_MUX               (CY_IPC0_INTR_MUX(CM0_IPC0_INTR_NUM))

#define CM33_S_IPC0_CH_NUM              (0x3u)
#define CM33_S_IPC0_CH_MASK             (CY_IPC_CH_MASK(CM33_S_IPC0_CH_NUM))
#define CM33_S_IPC0_INTR_NUM            (0x3u)
#define CM33_S_IPC0_INTR_MASK           (CY_IPC_INTR_MASK(CM33_S_IPC0_INTR_NUM))
#define CM33_S_IPC0_INTR_MUX            (CY_IPC0_INTR_MUX(CM33_S_IPC0_INTR_NUM))
...
#define IPC0_SEMA_CH_NUM                (4UL)
#define IPC0_SEMA_CH_MASK               (CY_IPC_CH_MASK(IPC0_SEMA_CH_NUM))

/* CM33 S IPC 1 channel */
#define CM33_S_IPC1_CH_NUM              (0x0u + IPC0_IPC_NR)
#define CM33_S_IPC1_CH_MASK             (CY_IPC_CH_MASK(CM33_S_IPC1_CH_NUM))
#define CM33_S_IPC1_INTR_NUM            (0x0u + IPC0_IPC_IRQ_NR)
#define CM33_S_IPC1_INTR_MASK           (CY_IPC_INTR_MASK(CM33_S_IPC1_INTR_NUM))
#define CM33_S_IPC1_INTR_MUX            (CY_IPC1_INTR_MUX(CM33_S_IPC1_INTR_NUM))
...
#define CY_IPC_CHAN_RRAM_LOCK           (6UL)
#define CY_IPC_INTR_RRAM_LOCK           (6UL)
#define CY_IPC_INTR_RRAM_LOCK_MASK      (CY_IPC_INTR_MASK(CY_IPC_INTR_RRAM_LOCK))

#define RESERVE_IPC0_CHANNELS           (7UL)
#define RESERVE_IPC0_INTERRUPTS         (7UL)
#else
#define RESERVE_IPC0_CHANNELS           (6UL)
#define RESERVE_IPC0_INTERRUPTS         (6UL)
#endif

#define RESERVE_IPC1_CHANNELS           (1UL)
#define RESERVE_IPC1_INTERRUPTS         (1UL)
...
/* user IPC channel */
#define CY_IPC_CHAN_USER                (IPC0_IPC_NR + RESERVE_IPC1_CHANNELS)   /** First ipc channel index of IPC1 instance meant for CM33 <-> CM55 */
/* user IPC interrupt */
#define CY_IPC_INTR_USER                (IPC0_IPC_IRQ_NR + RESERVE_IPC1_INTERRUPTS)   /** First ipc interrupt index of IPC1 instance meant for CM33 <-> CM55 */
