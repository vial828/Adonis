...
{
    174, 3, 127, 163, 5, 168, 172, 3, 65, 8, 
};
...
const _cyhal_trigger_source_explorer_t cyhal_mux0_sources[174] =
{
...
const _cyhal_trigger_source_explorer_t cyhal_mux2_sources[127] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_CANFD0_TR_DBG_DMA_REQ0,
    _CYHAL_TRIGGER_CANFD0_TR_FIFO00,
...
const _cyhal_trigger_source_explorer_t cyhal_mux3_sources[163] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT0,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT1,
...
const _cyhal_trigger_source_explorer_t cyhal_mux4_sources[5] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_DEBUG600_CTI_TR_OUT0,
    _CYHAL_TRIGGER_DEBUG600_CTI_TR_OUT1,
...
const _cyhal_trigger_source_explorer_t cyhal_mux5_sources[168] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT0,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT1,
...
const _cyhal_trigger_source_explorer_t cyhal_mux6_sources[172] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT0,
    _CYHAL_TRIGGER_M33SYSCPUSS_DW0_TR_OUT1,
...
const _cyhal_trigger_source_explorer_t cyhal_mux7_sources[3] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_DEBUG600_CTI_TR_OUT0,
    _CYHAL_TRIGGER_DEBUG600_CTI_TR_OUT1,
...
const _cyhal_trigger_source_explorer_t cyhal_mux8_sources[65] =
{
    _CYHAL_TRIGGER_M33SYSCPUSS_ZERO,
    _CYHAL_TRIGGER_TCPWM0_TR_OUT00,
    _CYHAL_TRIGGER_TCPWM0_TR_OUT01,
...
const _cyhal_trigger_source_explorer_t cyhal_mux9_sources[8] =
{
    _CYHAL_TRIGGER_SCB0_TR_TX_REQ,
    _CYHAL_TRIGGER_SCB0_TR_RX_REQ,
    _CYHAL_TRIGGER_SCB1_TR_TX_REQ,
...
const _cyhal_trigger_source_explorer_t* cyhal_mux_to_sources[10] =
{
    cyhal_mux0_sources, 
    cyhal_mux1_sources, 
    cyhal_mux2_sources, 
