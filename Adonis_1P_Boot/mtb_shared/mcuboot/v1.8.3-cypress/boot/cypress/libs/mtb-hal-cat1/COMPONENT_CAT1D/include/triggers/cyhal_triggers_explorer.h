...
typedef enum
{
    ...
    CYHAL_TRIGGER_PASS_TR_LPPASS_IN0 = 30, //!< P-DMA0 trigger multiplexer - pass.tr_lppass_in[0]
    CYHAL_TRIGGER_PASS_TR_LPPASS_IN1 = 31, //!< P-DMA0 trigger multiplexer - pass.tr_lppass_in[1]
    CYHAL_TRIGGER_PASS_TR_LPPASS_IN2 = 32, //!< P-DMA0 trigger multiplexer - pass.tr_lppass_in[2]
    CYHAL_TRIGGER_PASS_TR_LPPASS_IN3 = 33, //!< P-DMA0 trigger multiplexer - pass.tr_lppass_in[3]
    ...
    CYHAL_TRIGGER_SRSS_TR_DEBUG_FREEZE_MCWDT0 = 43, //!< PERI0 Freeze trigger multiplexer - srss.tr_debug_freeze_mcwdt[0]
    CYHAL_TRIGGER_SRSS_TR_DEBUG_FREEZE_MCWDT1 = 44, //!< PERI0 Freeze trigger multiplexer - srss.tr_debug_freeze_mcwdt[1]
    CYHAL_TRIGGER_SRSS_TR_DEBUG_FREEZE_WDT = 45, //!< PERI0 Freeze trigger multiplexer - srss.tr_debug_freeze_wdt
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN0 = 46, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[0]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN1 = 47, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[1]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN2 = 48, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[2]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN3 = 49, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[3]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN4 = 50, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[4]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN5 = 51, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[5]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN6 = 52, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[6]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN7 = 53, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[7]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN8 = 54, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[8]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN9 = 55, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[9]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN10 = 56, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[10]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN11 = 57, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[11]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN12 = 58, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[12]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN13 = 59, //!< TCPWM0_20_31 Trigger multiplexer - tcpwm[0].tr_all_cnt_in[13]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN14 = 60, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[14]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN15 = 61, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[15]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN16 = 62, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[16]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN17 = 63, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[17]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN18 = 64, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[18]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN19 = 65, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[19]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN20 = 66, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[20]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN21 = 67, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[21]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN22 = 68, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[22]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN23 = 69, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[23]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN24 = 70, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[24]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN25 = 71, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[25]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN26 = 72, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[26]
    CYHAL_TRIGGER_TCPWM0_TR_ALL_CNT_IN27 = 73, //!< Debug Reduction #1 - tcpwm[0].tr_all_cnt_in[27]
    CYHAL_TRIGGER_TCPWM0_TR_DEBUG_FREEZE = 74, //!< PERI0 Freeze trigger multiplexer - tcpwm[0].tr_debug_freeze
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN0 = 75, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[0]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN1 = 76, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[1]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN2 = 77, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[2]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN3 = 78, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[3]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN4 = 79, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[4]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN5 = 80, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[5]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN6 = 81, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[6]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN7 = 82, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[7]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN256 = 83, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[256]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN257 = 84, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[257]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN258 = 85, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[258]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN259 = 86, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[259]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN260 = 87, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[260]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN261 = 88, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[261]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN262 = 89, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[262]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN263 = 90, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[263]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN264 = 91, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[264]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN265 = 92, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[265]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN266 = 93, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[266]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN267 = 94, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[267]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN268 = 95, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[268]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN269 = 96, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[269]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN270 = 97, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[270]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN271 = 98, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[271]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN272 = 99, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[272]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN273 = 100, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[273]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN274 = 101, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[274]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN275 = 102, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[275]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN276 = 103, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[276]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN277 = 104, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[277]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN278 = 105, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[278]
    CYHAL_TRIGGER_TCPWM0_TR_ONE_CNT_IN279 = 106, //!< Debug Reduction #1 - tcpwm[0].tr_one_cnt_in[279]
    CYHAL_TRIGGER_TDM_TR_DBG_FREEZE = 107, //!< PERI1 Freeze trigger multiplexer - tdm.tr_dbg_freeze
...
extern const _cyhal_trigger_source_explorer_t* cyhal_mux_to_sources [10];
