...
#MTB_JLINK_DIR=C:/Program\ Files\ \(x86)/SEGGER\JLink
#MTB_JLINK_DIR=C:/Program\ Files/SEGGER\Jlink
...
#DEFINES+=CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE CY_USING_PREBUILT_CM0P_IMAGE
DEFINES+=CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE CY_SERIAL_FLASH_QSPI_THREAD_SAFE CY_USING_PREBUILT_CM0P_IMAGE CY_ENABLE_XIP_PROGRAM
DEFINES+=AW_HAVE_SNK
DEFINES+=CY_NO_ASSERT
DEFINES+=BLE_PROFILES_PROTOCOL_SUPPORT
DEFINES += MBEDTLS_USER_CONFIG_FILE="\"mbedtls_alt_config.h\""
...
ifeq ($(OTA_SUPPORT),1)
    ...
    ifeq ($(TARGET), $(filter $(TARGET), APP_CY8CPROTO-062-4343W APP_CY8CKIT-062S2-43012 APP_CY8CEVAL-062S2-LAI-4373M2 APP_CY8CEVAL-062S2-MUR-43439M2 APP_CY8CEVAL-062S2-CYW43022CUB))
       ...
       OTA_FLASH_MAP?=$(SEARCH_ota-update)/configs/flashmap/psoc62_1m_ext_overwrite_single2000.json
    ...
    MCUBOOT_KEY_DIR=./source/3_middleware/config/secret_keys
    #Name of the file containing the private key used for image signing
    MCUBOOT_KEY_FILE=adonis_key_ec_p256.pem
