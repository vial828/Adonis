...
#define  CAPSCOUNT_MAX          200 //change to 200 from 50 
#define  BIST_CARRIER_MODE      5
#define  BIST_TEST_DATA         8
#define  T_FIRST_SOURCE_CAP     50 //
...
#define T_ENTER_EPR                         500  //max=500ms

//I2C slave adress
	#define  TCPC_Address                  (0x9C)
...
typedef struct
{
    ...
    void  (*send_ctrl_msg)(CONTROL_MESSAGE_TYPE_e type,SOP_TYPE_e sop_type);
...
void  Set_Power_Role(unsigned char temp);
void  Set_Data_Role(unsigned char temp);
void  Set_PD_Rev(unsigned char temp);
