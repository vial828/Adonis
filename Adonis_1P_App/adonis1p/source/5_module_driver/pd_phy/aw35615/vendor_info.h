...
#define PD_Port_Type 0
/* 0: Src, 1: Snk, 2: DRP */
#define Type_C_State_Machine 1
...
#define Snk_PDO_Voltage1 100                //; Unit:50mV
#define Snk_PDO_Op_Current1 200             //; Unit:10mA
#define Snk_PDO_Min_Voltage1 0              //; 0V
#define Snk_PDO_Max_Voltage1 0              //; 0V
#define Snk_PDO_Op_Power1 0                 //; 0 W

#define Snk_PDO_Supply_Type2 0              //; 0: Fixed
#define Snk_PDO_Voltage2 180                //; Unit:50mV
#define Snk_PDO_Op_Current2 200             //; Unit:10mA
#define Snk_PDO_Min_Voltage2 0              //; 0V
#define Snk_PDO_Max_Voltage2 0              //; 0V
