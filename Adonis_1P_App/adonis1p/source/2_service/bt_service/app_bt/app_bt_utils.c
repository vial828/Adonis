...
void print_array(void * to_print, uint16_t len)
{
    ...
    for( counter = 0; counter<len;counter++ )
    {
       if( 0 == counter % 16 )
       {
        ...
        sm_log(SM_LOG_INFO, "%02X ", *(((uint8_t *)(to_print)) + counter) );
    }
    sm_log(SM_LOG_INFO, "\n" );
...
/****************************************************************************************
* @brief   data_array_invert_endianness
* @param
* @return  null
* @note
****************************************************************************************
