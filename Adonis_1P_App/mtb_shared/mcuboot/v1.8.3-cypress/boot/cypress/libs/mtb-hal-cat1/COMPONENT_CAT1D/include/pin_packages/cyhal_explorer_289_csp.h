...
#ifndef _CYHAL_EXPLORER_289_CSP_H_
#define _CYHAL_EXPLORER_289_CSP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_explorer_289_csp Explorer 289-CSP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the Explorer 289-CSP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 289-CSP package for the Explorer series. */
typedef enum {
...
} cyhal_gpio_explorer_289_csp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_explorer_289_csp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[126];
...
#endif /* _CYHAL_EXPLORER_289_CSP_H_ */
