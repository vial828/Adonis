...
/*wanggankun@2024-11-14, add, api for ext flash opt*/
cy_rslt_t ext_flash_read(uint32_t offset, uint8_t *buffer, size_t length);
cy_rslt_t ext_flash_write(uint32_t offset, const uint8_t *buffer, size_t length);
cy_rslt_t ext_flash_earse(uint32_t offset, uint32_t length);
